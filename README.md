...
- Relatively minimal overhead for the features it provides:
  ...
  - [~14685](test/ImplementationGas.t.sol) gas on the initial cold batched transaction call.
  - [~3185](test/ImplementationGas.t.sol) gas on the subsequent warm batched transaction call.
