...
- Relatively minimal overhead for the features it provides:
  ...
  - [~14668](test/ImplementationGas.t.sol) gas on the initial cold batched transaction call.
  - [~3168](test/ImplementationGas.t.sol) gas on the subsequent warm batched transaction call.
