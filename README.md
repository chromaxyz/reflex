...
- Relatively minimal overhead for the features it provides:
  - [~7948](test/ImplementationGas.t.sol) gas on the initial cold call.
  - [~948](test/ImplementationGas.t.sol) gas on the subsequent warm call.
  - [~14664](test/ImplementationGas.t.sol) gas on the initial cold batched transaction call.
  - [~3164](test/ImplementationGas.t.sol) gas on the subsequent warm batched transaction call.
